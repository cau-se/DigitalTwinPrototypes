...
class ClutchGearInterface(metaclass=ABCMeta):    
    ...
    @property
    @abstractmethod
    def pwm(self): raise NotImplementedError("Subclasses should implement this!")

    @pwm.setter
    @abstractmethod
    def pwm(self, pin_number): raise NotImplementedError("Subclasses should implement this!")
    ...
    @abstractmethod
    def rotate_by_angle(self, angle: Union[int, float]): raise NotImplementedError("Subclasses should implement this!")

    @abstractmethod
    def rotate_by_duty_cacly(self, percent: int): raise NotImplementedError("Subclasses should implement this!")